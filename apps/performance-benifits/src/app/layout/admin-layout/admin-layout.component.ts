...
import { GLOBAL_PERSISTANT_DATA, PRODUCT_SERVICES, THEMING_VARIABLE } from '../../constants/app-repo.constants';
import { filter, map } from 'rxjs/operators';

import { AppFilterModel } from '../../models/common/app-filter';
import { AppRepoHelperService } from '../../services/app-repo-helper.service';
import { AppRepoModel } from '../../models/common/app-repo';
...
export class AdminLayoutComponent implements OnInit {
  ...
  getTrimmed(userDisplayName:any) {
